...
if __name__ == '__main__':
    ...
    parser.add_argument('--model_path', type=str, default='./models/piechart/' ,
                        help='path for saving trained models')
    parser.add_argument('--crop_size', type=int, default=128,
                        help='size for randomly cropping images')
    parser.add_argument('--root_path', type=str, default='dataset/piechart/',
                        help='path for root')
    parser.add_argument('--log_step', type=int , default=10,
                        help='step size for prining log info')
    parser.add_argument('--save_step', type=int , default=600,
                        help='step size for saving trained models')
    parser.add_argument('--vocab_path', type=str, default='./data/piechart.pkl', 
